...
- Giving time & date updates
- Saving reminders in a text file
- Greeting and exiting commands
- Learning new commands continuously
...
- pywhatkit
- scikit-learn (for intent classifier)
- Wikipedia API

## Features
- Voice-controlled input and responses
